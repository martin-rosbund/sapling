...
export class Migration20260506204225 extends Migration {
  override up(): void | Promise<void> {
    ...
    this.addSql(
      `alter table "person_item" add "holiday_group_handle" int null;`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "favorite_item" add "search" varchar(256) null, add "sort_by" jsonb null, add "entity_route_handle" int null;`,
    );
    this.addSql(
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(
      `alter table "favorite_item" drop column "search", drop column "sort_by", drop column "entity_route_handle";`,
    );
