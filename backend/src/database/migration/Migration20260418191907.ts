...
export class Migration20260418191907 extends Migration {
  override up(): void | Promise<void> {
    ...
    this.addSql(
      `create table "ai_provider_model_item" ("handle" varchar(64) not null, "title" varchar(128) not null, "description" varchar(512) null, "provider_handle" varchar(64) not null, "provider_model" varchar(128) not null, "supports_streaming" boolean not null default true, "supports_tools" boolean not null default false, "max_tool_call_iterations" int not null default 8, "is_default" boolean not null default false, "is_active" boolean not null default true, "sort_order" int null default 0, "created_at" timestamptz not null, "updated_at" timestamptz not null, primary key ("handle"));`,
    );
    ...
    this.addSql(
      `create table "entity_route_item" ("handle" serial primary key, "route" varchar(64) not null, "navigation" varchar(128) null, "entity_handle" varchar(64) null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "event_status_item" ("handle" varchar(64) not null, "description" varchar(64) not null, "color" varchar(16) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, primary key ("handle"));`,
    );

    this.addSql(
      `create table "event_type_item" ("handle" varchar(64) not null, "title" varchar(128) not null, "icon" varchar(64) not null default 'mdi-calendar', "color" varchar(32) not null default '#4CAF50', "created_at" timestamptz not null, "updated_at" timestamptz not null, primary key ("handle"));`,
    );
    ...
    this.addSql(
      `create table "role_item" ("handle" serial primary key, "title" varchar(64) not null, "stage_handle" varchar(64) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "ticket_status_item" ("handle" varchar(64) not null, "description" varchar(64) not null, "color" varchar(16) not null, "icon" varchar(64) not null default 'mdi-new-box', "created_at" timestamptz not null, "updated_at" timestamptz not null, primary key ("handle"));`,
    );
    ...
    this.addSql(
      `create table "webhook_authentication_oauth2item" ("handle" serial primary key, "description" varchar(128) not null, "client_id" varchar(128) not null, "client_secret" varchar(256) null, "token_url" varchar(256) not null, "scope" varchar(256) null, "cached_token" varchar(256) null, "token_expires_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "webhook_subscription_item" ("handle" serial primary key, "description" varchar(128) not null, "url" varchar(256) not null, "custom_headers" jsonb null, "is_active" boolean not null default true, "signing_secret" varchar(128) null, "entity_handle" varchar(64) not null, "type_handle" varchar(64) not null default 'afterInsert', "payload_type_handle" varchar(64) not null default 'list', "method_handle" varchar(64) not null default 'post', "authentication_type_handle" varchar(64) null default 'none', "authentication_oauth2_handle" int null, "authentication_api_key_handle" int null, "authentication_basic_handle" int null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "company_item" ("handle" serial primary key, "name" varchar(128) not null, "street" varchar(128) not null, "zip" varchar(16) null, "city" varchar(64) null, "phone" varchar(32) null, "mobile" varchar(32) null, "email" varchar(128) null, "website" varchar(128) null, "is_active" boolean not null default true, "allow_newsletter" boolean not null default true, "country_handle" varchar(64) not null default 'DE', "work_week_handle" int null, "service_provider_handle" int null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `create table "person_item" ("handle" serial primary key, "first_name" varchar(64) not null, "last_name" varchar(64) not null, "login_name" varchar(64) null, "login_password" varchar(128) null, "phone" varchar(32) null, "mobile" varchar(32) null, "email" varchar(128) null, "birth_day" date null, "require_password_change" boolean not null default false, "is_active" boolean not null default true, "send_newsletter" boolean not null default true, "color" varchar(32) not null default '#4CAF50', "company_handle" int null, "type_handle" varchar(64) null default 'sapling', "department_handle" varchar(64) null, "language_handle" varchar(64) null default 'de', "work_week_handle" int null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `create table "phone_call_item" ("handle" serial primary key, "phone_number" varchar(64) not null, "note" varchar(2048) null, "reached" boolean not null default false, "entity_handle" varchar(64) not null, "reference" varchar(128) not null, "person_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );

    this.addSql(
      `create table "person_session_item" ("handle" serial primary key, "number" varchar(128) not null, "access_token" varchar(4096) not null, "refresh_token" varchar(4096) not null, "person_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `create table "information_item" ("handle" serial primary key, "reference" varchar(64) not null, "content" varchar(2048) not null, "entity_handle" varchar(64) not null, "person_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `create table "favorite_item" ("handle" serial primary key, "title" varchar(128) not null, "filter" jsonb null, "person_handle" int not null, "entity_handle" varchar(64) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "document_item" ("handle" serial primary key, "reference" varchar(64) not null, "path" varchar(128) not null, "filename" varchar(256) not null, "mimetype" varchar(128) not null, "length" int not null, "description" varchar(256) null, "entity_handle" varchar(64) not null, "type_handle" varchar(64) not null, "person_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "event_item" ("handle" serial primary key, "title" varchar(128) not null, "description" varchar(1024) null, "start_date" timestamptz not null, "end_date" timestamptz not null, "is_all_day" boolean not null default false, "online_meeting_url" varchar(512) null, "type_handle" varchar(64) not null default 'internal', "assignee_company_handle" int null, "assignee_person_handle" int null, "creator_company_handle" int not null, "creator_person_handle" int not null, "ticket_handle" int null, "sales_opportunity_handle" int null, "status_handle" varchar(64) not null default 'scheduled', "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    ...
    this.addSql(
      `create table "event_google_item" ("handle" serial primary key, "reference_handle" varchar(128) not null, "event_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `create table "event_azure_item" ("handle" serial primary key, "reference_handle" varchar(128) not null, "event_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "person_item" add constraint "person_item_company_handle_foreign" foreign key ("company_handle") references "company_item" ("handle") on delete set null;`,
    );
    this.addSql(
