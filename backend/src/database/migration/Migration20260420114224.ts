...
export class Migration20260420114224 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`create table "script_button_item" ("handle" serial primary key, "name" varchar(128) not null, "title" varchar(128) not null, "parameter" jsonb null, "is_multi_select" boolean not null default false, "entity_handle" varchar(64) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    ...
    this.addSql(`create table "person_api_token_item" ("handle" serial primary key, "description" varchar(128) not null, "token_prefix" varchar(24) not null, "token_hash" varchar(128) not null, "is_active" boolean not null default true, "expires_at" timestamptz not null, "last_used_at" timestamptz null, "allowed_ips" jsonb null, "person_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    this.addSql(`alter table "person_api_token_item" add constraint "person_api_token_item_token_hash_unique" unique ("token_hash");`);
    ...
    this.addSql(`create table "event_item" ("handle" serial primary key, "title" varchar(128) not null, "description" varchar(1024) null, "start_date" timestamptz not null, "end_date" timestamptz not null, "is_all_day" boolean not null default false, "online_meeting_url" varchar(512) null, "type_handle" varchar(64) not null default 'internal', "assignee_company_handle" int null, "assignee_person_handle" int null, "creator_company_handle" int not null, "creator_person_handle" int not null, "ticket_handle" int null, "sales_opportunity_handle" int null, "status_handle" varchar(64) not null default 'scheduled', "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    ...
    this.addSql(`create table "event_google_item" ("handle" serial primary key, "reference_handle" varchar(1024) not null, "event_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    ...
    this.addSql(`create table "event_azure_item" ("handle" serial primary key, "reference_handle" varchar(1024) not null, "event_handle" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    ...
    this.addSql(`alter table "script_button_item" add constraint "script_button_item_entity_handle_foreign" foreign key ("entity_handle") references "entity_item" ("handle");`);
    ...
    this.addSql(`alter table "sales_opportunity_item" add constraint "sales_opportunity_item_assignee_company_handle_foreign" foreign key ("assignee_company_handle") references "company_item" ("handle") on delete set null;`);
    this.addSql(`alter table "sales_opportunity_item" add constraint "sales_opportunity_item_assignee_person_handle_foreign" foreign key ("assignee_person_handle") references "person_item" ("handle") on delete set null;`);
    this.addSql(`alter table "sales_opportunity_item" add constraint "sales_opportunity_item_creator_company_handle_foreign" foreign key ("creator_company_handle") references "company_item" ("handle");`);
    this.addSql(`alter table "sales_opportunity_item" add constraint "sales_opportunity_item_creator_person_handle_foreign" foreign key ("creator_person_handle") references "person_item" ("handle");`);
    ...
    this.addSql(`alter table "person_api_token_item" add constraint "person_api_token_item_person_handle_foreign" foreign key ("person_handle") references "person_item" ("handle");`);
    ...
    this.addSql(`alter table "ai_chat_message_item" add constraint "ai_chat_message_item_person_handle_foreign" foreign key ("person_handle") references "person_item" ("handle");`);
