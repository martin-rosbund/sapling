...
import SaplingTableFilterText from './SaplingTableFilterText.vue';

interface SaplingTableFilterPercentProps {
  modelValue: string;
  title: string;
...
defineProps<SaplingTableFilterPercentProps>();
