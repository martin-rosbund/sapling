...
const formattedValue = computed(() => formatDateTimeValue(props.value, props.dateValue, props.timeValue));
const stateClass = computed(() => `sapling-date-field--${props.isDeadline ? getDateTimeCellState(props.value, props.dateValue, props.timeValue) : 'default'}`);
</script>
