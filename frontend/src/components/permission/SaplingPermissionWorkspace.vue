    ...
    <section class="sapling-permission-workspace glass-panel">
        <div class="sapling-permission-toolbar">
            ...
            <div class="sapling-permission-toolbar-actions">
                ...
                <v-btn-toggle v-model="permissionFilterModeModel" color="primary" density="comfortable" mandatory>
                    ...
                    >
                        ...
                        <td class="text-right">
                            <div class="sapling-permission-row-actions">
                                <v-btn size="x-small" variant="text" @click="emit('grantEntityAccess', item)">{{ $t('right.all') }}</v-btn>
                                <v-btn size="x-small" variant="text" @click="emit('clearEntityAccess', item)">{{ $t('right.none') }}</v-btn>
                            </div>
                        </td>
                    </tr>
                </tbody>
...
const emit = defineEmits<{
    ...
    (event: 'togglePermission', item: EntityItem, permissionType: PermissionColumnKey, value: boolean): void;
