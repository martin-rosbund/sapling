<template>
  ...
  >
    <div
      class="sapling-preview-media-surface sapling-preview-media-surface--stacked sapling-file-media-surface sapling-file-media-surface--stacked"
    >
      <div
      ...
      >
        <div
          class="sapling-row-md sapling-preview-media-card__header sapling-file-media-card__header"
        >
          <div
            class="sapling-icon-tile sapling-preview-media-card__icon sapling-file-media-card__icon"
          >
          ...
          <div class="sapling-preview-media-card__copy sapling-file-media-card__copy">
            <div
              class="sapling-chip-row sapling-preview-media-card__eyebrow-row sapling-file-media-card__eyebrow-row"
            >
              <span
                class="sapling-soft-chip sapling-preview-media-card__pill sapling-file-media-card__pill"
                >{{ formatLabel }}</span
              >
              <span class="sapling-preview-media-card__meta sapling-file-media-card__meta">{{
                mimeType || 'audio/mpeg'
              }}</span>
            </div>
          </div>
